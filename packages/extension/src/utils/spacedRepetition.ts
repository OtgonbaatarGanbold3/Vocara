...
/** Review card state for SM-2 */
export interface ReviewCard {
  /** Current ease factor (starts at 2.5, minimum 1.3) */
  easeFactor: number;
 ...
 */
export function createReviewCard(): ReviewCard {
  return {
    easeFactor: 2.5,
    interval: 0,
    repetitions: 0,
 ...
 */
export function gradeCard(card: ReviewCard, grade: number): ReviewCard {
  if (grade < 0 || grade > 5) {
 ...
 */
export function getNextReviewDate(card: ReviewCard): Date {
